...
function DaneProduktu({setKod,setNazwa,setOpis,setWyglad,setZakup}) {
  return (
    <div className='dane-firmy'>
        ...
        <p>Data zakupu : <input placeholder='data-zakupu' onChange={ (e) => setZakup(e.target.value)}></input></p>
